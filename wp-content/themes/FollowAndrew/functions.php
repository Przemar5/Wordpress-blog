...
function followandrew_register_styles()
{
	...
	wp_enqueue_style('followandrew-style', 
		get_template_directory_uri() . '/style.css', 
		['followandrew-bootstrap'], $version, 'all');
	wp_enqueue_style('followandrew-bootstrap', 
		'https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/css/bootstrap.min.css', 
		[], '4.4.1', 'all');
	wp_enqueue_style('followandrew-fontawesome', 
...
{
	wp_enqueue_script('followandrew-jquery', 
		'https://code.jquery.com/jquery-3.4.1.slim.min.js', 
		[], '3.4.1', true);
	wp_enqueue_script('followandrew-popper', 
		'https://cdn.jsdelivr.net/npm/popper.js@1.16.0/dist/umd/popper.min.js', 
		[], '1.16.0', true);
	wp_enqueue_script('followandrew-bootstrap', 
		'https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/js/bootstrap.min.js', 
		['followandrew-jquery'], '4.4.1', true);
	wp_enqueue_script('followandrew-main', 
